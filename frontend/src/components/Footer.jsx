  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm px-3 sm:px-[5vw] md:px-[4vw] lg:px-[9vw]'>
        <div>
          ...
          <p className='w-full md:w/2/3 text-gray-600'>
            Welcome back! Sign in to your account to continue where you left off. Secure, fast,
            and easy access to your personalized experience.
          </p>
        </div>
        <div>
      ...
      <div className='flex items-center justify-center w-full bg-white py-5'>
        {/* Left line image */}
        <img className='w-2/6  h-8' src={line} alt="Line" />
        
        {/* Copyright text in the center */}
        <p className='text-sm py-1  h-7 mx-4 '>Copyright 2025@ JEDID.com - ALL Right Reserved</p>
