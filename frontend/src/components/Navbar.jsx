...
// import logo from '../assets/freepik__circular-logo-with-a-habesha-dress-at-the-center-j__98734.jpeg';
...
//           <Link to='/login'><img className='w-15' src={profile_icon} alt="" /></Link>
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium p-5'>
            ...
            <Link to='/collection'>
                ...
                <div className='group relative'>
                    <Link to='/login'>
                        <img className='w-13 min-w-5' src={profile_icon} alt="Profile" />
                    </Link>
                    <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
                        <div className='flex flex-col gap-2 w-36 bg-slate-100 text-gray-500 rounded'>
                            <p className='cursor-pointer hover:text-black'>My Profile</p>
